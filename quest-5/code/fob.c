...
static const char *TAG_UART = "ec444: uart";
...
// needed functions for communicating with the server
...
// The task to sent the fob id to the meter id. 
...
// controls the LEDs to show the status
...
// needed for the button and LEDs
void button_task(){
  uint32_t io_num;
  while(1) {
...
//communicates with the server and gets a meter id and status in return 
