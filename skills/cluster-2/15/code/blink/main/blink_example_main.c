...
#define ACK_VAL                            0x00
#define NACK_VAL                           0xFF  // Updated value
...
static void i2c_master_init() {
    ...
    conf.clk_flags = 0;  // Additional configuration from the second code
...
dataRate_t getDataRate(void) {
    return (dataRate_t)(readRegister(ADXL343_REG_BW_RATE) & 0x0F);  // Using the appropriate register
}
